...
const BlogCost = () => {
  return (
    ...
    <div className="flex-blog-section">
      <h2 className="blog-pages-heading">Renovating Your Home: <span className="blog-pages-heading-change">Factors that affect the cost of a renovation</span></h2>
      <h3 className="blog-pages-h3"><span className="color-change-steps">Step 1:</span> The scope of the project </h3>
      <p className="blog-pages-p">The larger the project, the more expensive it will be. A complete home renovation will cost more than a minor update to your bathroom or kitchen.</p>

      <h3 className="blog-pages-h3"><span className="color-change-steps">Step 2:</span> Materials</h3>
      ...
      <h3 className="blog-pages-h3"><span className="color-change-steps">Step 3:</span> Labor costs</h3>
      ...
      <h3 className="blog-pages-h3"><span className="color-change-steps">Step 4:</span> Permits</h3>
      ...
      <h3 className="blog-pages-h3"><span className="color-change-steps">Step 5:</span> Unexpected expenses</h3>
